...
### [Criar Banco de Dados Azure SQL](azure-sql/azure-sql-criar-banco-dados.md)
...
### [Migrar dados do SQL Server para Azure Sql Dabatase](azure-sql/sql-server-migrar-dados-azure-sql.md)
...
### [Migrar esquema e dados do SQL Server para Azure SQL](azure-sql/azure-sql-migrar-esquema-dados-sql-server.md)
...
### [Criar Banco de Dados Azure SQL no Azure Data Studio](azure-sql/azure-data-studio-criar-sql-database.md)
...
### [Como Criar e Quanto Custa o Azure SQL Managed Instance](azure-sql/azure-sql-managed-instance-create.md)
...
### [Obter Função NETWORKDAYS no DAX e Azure SQL](azure-sql/azure-sql-dax-funcao-networkdays.md)
